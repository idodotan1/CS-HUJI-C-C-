...
{
private:
    std::map<sp_movie, std::vector<double>,movie_comparator>
            _movie_list;
    double calculate_norm(const std::vector<double>& v);
    double inner_product(const std::vector<double>& v1,const
    std::vector<double>& v2);
    double calculate_angle(const std::vector<double>& v1,const
    std::vector<double>& v2);
public:
